...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_common_models_Discussion__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'badges', function (badges) {
    if (this.tags()) {
      ...
      if (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('canWriteBlogPosts')) {
        badges.add('blog', m((flarum_common_components_Badge__WEBPACK_IMPORTED_MODULE_3___default()), {
          label: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.badge.blog'),
          icon: "fas fa-newspaper",
          type: "blog"
        }));
        if (this.blogMeta() && this.blogMeta().isPendingReview() == true) {
          if (Date.parse(this.blogMeta().publishDate())) {
            badges.add('pending_date', m((flarum_common_components_Badge__WEBPACK_IMPORTED_MODULE_3___default()), {
              label: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.badge.pending_date'),
              icon: "fas fa-calendar",
              type: "pending_date"
            }));
          } else {
            badges.add('pending', m((flarum_common_components_Badge__WEBPACK_IMPORTED_MODULE_3___default()), {
              label: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.badge.pending'),
              icon: "fas fa-clock",
              type: "pending"
            }));
          }
        ...
        if (this.blogMeta() == false) {
          badges.add('missing_meta', m((flarum_common_components_Badge__WEBPACK_IMPORTED_MODULE_3___default()), {
            label: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.badge.missing_meta'),
...
var FeaturedBlogItem = /*#__PURE__*/function (_Component) {
  ...
  _proto.topItems = function topItems() {
    ...
    if ((_article$blogMeta2 = article.blogMeta()) != null && _article$blogMeta2.isPendingReview != null && _article$blogMeta2.isPendingReview()) {
      var title = flarum_forum_app__WEBPACK_IMPORTED_MODULE_8___default().translator.trans('v17development-flarum-blog.forum.review_article.pending_review_title');
      var text = flarum_forum_app__WEBPACK_IMPORTED_MODULE_8___default().translator.trans('v17development-flarum-blog.forum.review_article.pending_review');
      var iconName = "far fa-clock";
      if (Date.parse(article.blogMeta().publishDate())) {
        title = flarum_forum_app__WEBPACK_IMPORTED_MODULE_8___default().translator.trans('v17development-flarum-blog.forum.review_article.withdraw_review_title');
        text = flarum_forum_app__WEBPACK_IMPORTED_MODULE_8___default().translator.trans('v17development-flarum-blog.forum.review_article.withdraw_review');
      ...
      }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_5___default()(iconName), "  ", title)), 40);
    }
    return items;
  };
  _proto.dataItems = function dataItems() {
...
/* harmony import */ var _pages_BlogOverview__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/BlogOverview */ "./src/forum/pages/BlogOverview.js");
/* harmony import */ var _utils_redirector__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/redirector */ "./src/forum/utils/redirector.js");
/* harmony import */ var _common_Models_BlogMeta__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/Models/BlogMeta */ "./src/common/Models/BlogMeta.js");
/* harmony import */ var _utils_extendTagOverview__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/extendTagOverview */ "./src/forum/utils/extendTagOverview.js");
/* harmony import */ var _utils_discussionRouting__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils/discussionRouting */ "./src/forum/utils/discussionRouting.js");
/* harmony import */ var _pages_BlogComposer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./pages/BlogComposer */ "./src/forum/pages/BlogComposer.js");
/* harmony import */ var _compat__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./compat */ "./src/forum/compat.js");
/* harmony import */ var _utils_addSidebarNav__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/addSidebarNav */ "./src/forum/utils/addSidebarNav.js");
/* harmony import */ var _pages_BlogItem__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./pages/BlogItem */ "./src/forum/pages/BlogItem.js");
/* harmony import */ var _utils_addPreferences__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./utils/addPreferences */ "./src/forum/utils/addPreferences.js");
/* harmony import */ var _components_UserCard__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/UserCard */ "./src/forum/components/UserCard.js");
/* harmony import */ var _components_AddDiscussionControls__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/AddDiscussionControls */ "./src/forum/components/AddDiscussionControls.js");
/* harmony import */ var _components_AddEditorButtons__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/AddEditorButtons */ "./src/forum/components/AddEditorButtons.js");
/* harmony import */ var _components_AddBadges__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/AddBadges */ "./src/forum/components/AddBadges.js");
/* harmony import */ var _pages_BlogPending__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./pages/BlogPending */ "./src/forum/pages/BlogPending.js");
/* harmony import */ var _pages_BlogList__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./pages/BlogList */ "./src/forum/pages/BlogList.js");
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('v17development-flarum-blog', function (app) {
  app.routes.blog = {
    path: '/blog',
    component: _pages_BlogOverview__WEBPACK_IMPORTED_MODULE_5__["default"]
  };
  ...
  app.routes.blogComposer = {
    path: '/blog/compose',
    component: _pages_BlogComposer__WEBPACK_IMPORTED_MODULE_10__["default"]
  };
  app.routes.blogPending = {
    path: '/blog/pending',
    component: (flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_4___default())
  };
  app.routes.blogList = {
    path: '/blog/list',
    component: (flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_4___default())
  ...
  app.routes.blogArticle = {
    path: '/blog/:id',
    component: _pages_BlogItem__WEBPACK_IMPORTED_MODULE_13__["default"]
  };
  app.routes['blogArticle.near'] = {
    path: '/blog/:id/:near',
    component: _pages_BlogItem__WEBPACK_IMPORTED_MODULE_13__["default"]
  };
  app.store.models.blogMeta = _common_Models_BlogMeta__WEBPACK_IMPORTED_MODULE_7__["default"];
  ...
  (0,_utils_redirector__WEBPACK_IMPORTED_MODULE_6__["default"])();

  // Extend tag overview.
  // Hide tags which are used as blog category
  (0,_utils_extendTagOverview__WEBPACK_IMPORTED_MODULE_8__["default"])();

  // Make that blog articles have a blog route and not a discussion route
  (0,_utils_discussionRouting__WEBPACK_IMPORTED_MODULE_9__["default"])();

  // Add a link to the blog to the IndexPage sidebar, if enabled.
  (0,_utils_addSidebarNav__WEBPACK_IMPORTED_MODULE_12__["default"])();
  (0,_utils_addPreferences__WEBPACK_IMPORTED_MODULE_14__["default"])();
  (0,_components_UserCard__WEBPACK_IMPORTED_MODULE_15__["default"])();
  (0,_components_AddEditorButtons__WEBPACK_IMPORTED_MODULE_17__["default"])();
  (0,_components_AddDiscussionControls__WEBPACK_IMPORTED_MODULE_16__["default"])();
  (0,_components_AddBadges__WEBPACK_IMPORTED_MODULE_18__["default"])();
  (0,_pages_BlogPending__WEBPACK_IMPORTED_MODULE_19__["default"])();
  (0,_pages_BlogList__WEBPACK_IMPORTED_MODULE_20__["default"])();
}, -100000);
(0,_compat__WEBPACK_IMPORTED_MODULE_11__["default"])();
  ...
  _proto.postItems = function postItems() {
    ...
    if (!this.loading) {
      ...
      if ((_this$article$blogMet = (_this$article4 = this.article).blogMeta) != null && (_this$article$blogMet = _this$article$blogMet.call(_this$article4)) != null && _this$article$blogMet.isPendingReview != null && _this$article$blogMet.isPendingReview()) {
        var text = flarum_forum_app__WEBPACK_IMPORTED_MODULE_15___default().translator.trans('v17development-flarum-blog.forum.review_article.pending_review');
        var iconName = "far fa-clock";
        if (Date.parse(this.article.blogMeta().publishDate())) {
          text = flarum_forum_app__WEBPACK_IMPORTED_MODULE_15___default().translator.trans('v17development-flarum-blog.forum.review_article.withdraw_review');
          iconName = "far fa-calendar";
        }
        ...
        }, m("div", null, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_14___default()(iconName, {
          style: {
            marginRight: '5px'
          }
        }), ' ', text))), 60);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default().prototype), 'navItems', function (items) {
    var params = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().search.stickyParams();
    items.add('blogList', m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_2___default()), {
      href: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().route('blogList', params),
      icon: "fas fa-newspaper"
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.articles')), 50);
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default().prototype), 'setTitle', function () {
    if (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().current.get('routeName') === 'blogList') {
      flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().setTitle(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.articles'));
    }
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_4___default().prototype), 'requestParams', function (params) {
    if (typeof params.include === 'string') {
      ...
      var _params$include;
      (_params$include = params.include) == null || _params$include.push('blogMeta', 'firstPost', 'user');
    }
    if (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().current.get('routeName') === 'blogList') {
      var _params$filter;
      params.filter = (_params$filter = params.filter) != null ? _params$filter : {};
...
var BlogOverview = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return [flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().forum.attribute('blogAddHero') == true && flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default().prototype.hero(), m("div", {
      ...
      href: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().route('blogList'),
      className: 'FlarumBlog-reached-load-more'
    }, m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_4___default()), {
      "class": 'Button'
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('v17development-flarum-blog.forum.read_more'))))), m("div", {
      className: 'Sidebar'
...
/***/ "./src/forum/pages/BlogPending.js":
/*!****************************************!*\
  !*** ./src/forum/pages/BlogPending.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default().prototype), 'navItems', function (items) {
    if ((flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().session).user && flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('canApproveBlogPosts')) {
      var params = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().search.stickyParams();
      items.add('blogPending', m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_2___default()), {
        href: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().route('blogPending', params),
        icon: "fas fa-clock"
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.pending')), 50);
    }
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default().prototype), 'setTitle', function () {
    if (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().current.get('routeName') === 'blogPending') {
      flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().setTitle(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('v17development-flarum-blog.forum.pending'));
    }
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_4___default().prototype), 'requestParams', function (params) {
    if (typeof params.include === 'string') {
